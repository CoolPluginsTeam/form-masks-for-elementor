...
class cfef_feedback {
		...
		private $plugin_url     = FME_PLUGIN_URL;
		private $plugin_version = FME_VERSION;
		private $plugin_name    = 'Form Input Masks for Elementor Form';
		private $plugin_slug    = 'fme';
	...
	function submit_deactivation_response() {
		if ( ! isset( $_POST['_wpnonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash($_POST['_wpnonce'])), '_cool-plugins_deactivate_feedback_nonce' ) ) {
			...
			$deactivate_reasons = array(
				...
				'other'                          => array(
					'title'             => __( 'Other', 'form-masks-for-elementor' ),
					'input_placeholder' => __( 'Please share the reason.', 'form-masks-for-elementor' ),
				),
			);
